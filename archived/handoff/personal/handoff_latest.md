...
> **15代目 Wiki-Eval Migration Note (2026-04-28)**: 本ファイルは `wiki/casual/handoff_latest.md` から **物理移設のみ** 実施した（中身は触らない・ADR-Role v3 §14 遵守）。中身改訂（Wiki-Personal 反映・サブ層 5 層記述等）は **Personal-Planner 業務**。
