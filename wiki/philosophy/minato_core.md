...
Obisidianを導入した主な目的は、プロジェクト進捗とロジック設計の微細な変更を各担当者がリアルタイムで共有できるところだ。NLMのプロジェクト専用ラグとは違い敢えて単一で設計したのもの大脳皮質のような自律的判断と創造性を確保したいからだ。
よって２つの_code.mdも歴代が得た気づきと体験から生まれた記憶の様に機能するれば良いと思う。
人間にとって実体験から生まれた記憶は、成功も失敗も資産となり得るので。
