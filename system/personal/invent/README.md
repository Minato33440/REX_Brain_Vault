...
> **15代目 Wiki-Eval Migration Note (2026-04-28)**: 旧 `wiki/casual/ideas/README.md` を `wiki/personal/invent/README.md` に物理移設(ideas → invent ディレクトリ名変更)。**中身は触らない**(ideas → invent の名称変更を反映する README 改訂は Personal-Planner 業務)。
