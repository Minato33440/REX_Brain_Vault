> [!warning]
> **[SUPERSEDED]** This ADR has been superseded by [ADR-Role v3 (2026-04-28)](../ADR-Role.md).
>
> **Supersede 日**: 2026-04-28（同日改訂）
>
> **Supersede 理由**:
> - v2 §12「STARTUP_CODES.md は Personal-Planner が管理」がボス指示「構造変更は Wiki-Eval 管轄」と矛盾
> - Wiki-Eval の Vault 管理権限が ADR で未明文化（15代目セッションで過度な保守的解釈が発生）
> - 構造変更 vs 中身変更の境界が未定義
>
> **v3 での主な変更**:
...
**Supersedes**: [ADR-Role v1 (2026-04-27)](ADR-Role-2026-04-27.md)
...
- [archived/ADR-Role-2026-04-27.md](ADR-Role-2026-04-27.md) - v1 (Superseded)
