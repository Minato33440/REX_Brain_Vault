...
# 更新: 2026-04-25（11 代目 文書編集プロトコル R1-R3 追加・10 代目事故対策）
# 前版: 2026-04-24（9 代目 役割再定義対応・起動コード改名反映）
...
- **発動条件**: `filesystem:edit_file` / `github:create_or_update_file` / `github:push_files` のいずれかを実行した直後
